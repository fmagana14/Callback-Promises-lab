fetch('https://jsonplaceholder.typicode.com/todos/1')
  ...
  .then(data => {
    console.log(data); // Should log: { userId: 1, id: 1, title: 'delectus aut autem', completed: false }
  })
  .catch(error => {
...
// Simulate an error by changing the URL above to: 
...
fetch('https://jsonplaceholder.typicode.com/')
  ...
  .catch(error => {
    console.error('Error fetching data:', error); // Should log an error message
  });
